  ...
  },
{
    ...
    authors: ["Ahmed Khawaja", "Joshua Landgraf", "Rohith Prakash", "Michael Wei", "Eric Schkufza", "Christopher Rossbach"], 
    venue: "OSDI 2018",
    bib: "https://dblp.uni-trier.de/rec/bibtex/conf/asplos/SchkufzaWR19", 
  },
  {
    title: "A Compiler-Insensitive Technique for Identifying Third-Party Components in x86-64 Binaries", 
  ...
  },
  {
    ...
    authors: ["Himanshu Chauhan", "Irina Calciu", "Vijay Chidambaram", "Eric Schkufza", "Onur Mutlu", "Pratap Subrahmanyam"], 
  ...
  },
  {
    ...
    authors: ["Rahul Sharma", "Eric Schkufza", "Berkeley R. Churchill", "Alex Aiken"], 
    venue: "OOPSLA 2015",
  ...
  },
  {
    ...
    authors: ["Paul Merrell", "Eric Schkufza", "Zeyang Li", "Maneesh Agrawala", "Vladlen Koltun"], 
    venue: "SIGGRAPH 2011",
  ...
  },
  {
    ...
    authors: ["Evan Cox", "Eric Schkufza", "Ryan Madsen", "Michael R. Genesereth"], 
    venue: "GIGA 2009",
    bib: "giga_09.bib", 
  },
  {
  ...
  },
  {
    ...
    authors: ["Nat Love", "Tim Hinrichs", "David Haley", "Eric Schkufza", "Michael R. Genesereth"], 
...
function About({name, bio}: AboutProps) {
...
function Cites({citations}: CitesProps) {
  return <Stack direction="column" sx={{width: "100%", alignItems: "left", gap: 1}}>
    {citations.map((citation)=><Cite citation={citation}/>)}
  </Stack>
}